# [SOLVED] Error-Quot-Importerror-No-Module-Named-Requests-Quot
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/error-quot-importerror-no-module-named-requests-quot)
>
...
Install the requests library by running the command 'python -m pip install requests' in your terminal or command prompt.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/error-quot-importerror-no-module-named-requests-quot)**
